...
def importarNovasAbas(dataFrameSalas, dataFrameTubo, nomeSalas, nomeTubo):
    ...
    caminhoExcel = os.path.normpath(os.path.join(get_executable_path(), '../../Backup/Qualificacao.xlsx'))
    caminhoSalvar = os.path.normpath(os.path.join(get_executable_path(), "../../Resultado"))
