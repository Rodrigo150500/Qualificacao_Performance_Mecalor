...
def gerarNovaAbaLog(nomeLogs):
    ...
    caminho = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../Backup/QP.xlsx'))
    ...
    for nomeLog in nomeLogs:
        ...
        log = os.path.abspath(os.path.join(os.path.dirname(__file__), f'../../Resultado/LogsAtualizados/{nomeLog[1]}'))
    ...
    excel.save(os.path.abspath(os.path.join(os.path.dirname(__file__), "../../Resultado/QP.xlsx")))
